...
{
    class MockedCustomerRepository : ICustomerRepository
    {
        ...
        public MockedCustomerRepository()
        {
           ...
           customers = fixture.CreateMany<Customer>(30).ToList();
        }
        ...
        {
            return customers.FirstOrDefault(c => c.FirstName == firstName
            && c.LastName == lastName);
        }
